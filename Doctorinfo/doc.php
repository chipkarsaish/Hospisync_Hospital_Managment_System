...
// Assuming the doctor's ID is stored in the session after login
if (isset($_SESSION['user_id'])) {
    $doctor_id = $_SESSION['user_id'];

    // Fetch doctor information from the database
    $query = "SELECT Name, email, specialization, experience FROM doctors WHERE id = ?";
...
<html lang="en">
  ...
  <nav class="navbar bg-body-tertiary">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Doctor Info</a>
      </li>
      <li class="nav-item">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Specialization: <?php echo $doctor['specialization']; ?></li>
                <li class="list-group-item">Years of experience: <?php echo $doctor['experience']; ?></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <script>
        function confirmLogout() {
            if (confirm("Are you sure you want to logout?")) {
                ...
                window.location.href = '../Main_Page/main.php'; // Replace 'logout.php' with your actual logout URL
            }
        }
    </script>
  </body>
