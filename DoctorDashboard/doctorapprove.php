...
include('move_patient_1.php');
$query = "SELECT id, Name, PhoneNumber, DateOfAppointment, PreferredTime FROM archived_patient;";
...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="doctorpatient.php">New Appointments</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="doctorapprove.php">Patients Checked</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="prevpatients.php">Previous Patients Info.</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" href="../opd/main1.php">OPD Managment</a>
      </li>
    </ul>
    <div id="layoutSidenav_content">
        <div class="container-fluid px-4">
            <h1 class="mt-4">Patients Approved</h1>
    ...
    <tr>
        ...
        <td>
            ...
            <?php if (!empty($row['pdf_file_path'])) { ?>
                <a href="../DownloadPHP/download_pdf2.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary">Download Report</a>
            <?php } else { ?>
                <span>No PDF</span>
            <?php } ?>
        </td>
