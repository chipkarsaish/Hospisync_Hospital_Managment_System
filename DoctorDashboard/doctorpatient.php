...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="doctorpatient.php">New Appointments</a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="doctorapprove.php">Patients Checked</a>
        </li>
        <li class="nav-item">
